        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-black text-white flex items-center gap-3 drop-shadow-md">
              <Target className="w-8 h-8 text-sky-400" /> Monthly Budgets
            </h1>
        ...
        {showForm && (
          ...
          >
            <h3 className="text-white font-bold text-base flex items-center gap-2">
              <Sparkles className="w-5 h-5 text-amber-300" /> Create New Monthly Budget
            </h3>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-1 mt-2">
                  {[
                    ...
                    >
                      <FoodDoodle type={getCharacterType(item.cat)} size={14} />
                ...
                >
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-3">
                      <FoodDoodle type={getCharacterType(b.category)} size={36} />
                      <p className="text-white font-bold text-base tracking-wide">{b.category}</p>
                    </div>
